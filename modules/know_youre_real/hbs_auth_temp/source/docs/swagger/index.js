...
program
  ...
  .option(
    "-i, --input <*.json|yaml|yml file>",
    "input a main/entry JSON/YAML swagger file, MANDATORY",
    /^.+\.(json|yaml|yml)$/gi,
    null
  )
  .option(
    "-o, --output <*.json|yaml|yml file>",
    "output a merged JSON/YAML swagger file, default is `swagger.*`",
    /^.+\.(json|yaml|yml)$/gi,
    null
  )
