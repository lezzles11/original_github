...
* @returns {any}
*/
function createOne(object, needThese = {}, currIndex) {
    ...
    let merged = extend(newObj, needThese);
    return merged;
}
/**
* @description 
...
* @returns {any}
*/
function createOneDirty(object, needThese = {}, currIndex) {
    let values = Object.keys(object)
    let newObj = {}
    for (let i = 0; i < values.length; i++) {
        let eachKey = values[i]
...
* @returns {array}
*/
function createMany(object, length = 1, addId = false, mustHave = {}) {
    let newArr = []
...
* @returns {any}
*/
function createManyDirty(object, length = 1, addId = false, mustHave = {}) {
    let newArr = []
    for (let i = 0; i < length; i++) {
        let id = i + 1;
...
export { getChance, getDirty, getOne, createManyDirty, createMany, createOneDirty, createOne }