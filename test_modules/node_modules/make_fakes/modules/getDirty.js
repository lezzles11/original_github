...
const { getChance } = require("./getChance");

function getDirty(key) {
    ...
    switch (key) {
        ...
        case "date":
            if (random === 1) {
                let dirtyOne = formatDateTime.format(getChance.past_date(), "L")
                return dirtyOne
            } else if (random === 2) {
                let dirtyOne = formatDateTime.format(getChance.past_date(), "LL")
                return dirtyOne
            } else {
                return undefined;
            }
        case "past_date":
            if (random === 1) {
                let dirtyOne = formatDateTime.format(getChance.past_date(), "dateInput")
                return dirtyOne;
            } else if (random === 2) {
                let dirtyTwo = formatDateTime.format(getChance.future_date(), "LL")
                return dirtyTwo;
            } else {
                return undefined;
            }
        case "future_date":
            if (random === 1) {
                let dirtyOne = formatDateTime.format(getChance.future_date(), "L")
                return dirtyOne;
            } else if (random === 2) {
                let dirtyTwo = formatDateTime.format(getChance.future_date(), "l")
                return dirtyTwo;
            } else {
                return undefined;
            }
        case "number_date":
            if (random === 1) {
                let dirtyOne = formatDateTime.format(getChance.future_date(), "dateInput")
                return dirtyOne;
            } else if (random === 2) {
                let dirtyTwo = formatDateTime.format(getChance.future_date(), "ll")
                return dirtyTwo;
